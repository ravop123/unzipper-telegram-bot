...
async def button_callback(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # ---------- ARCHIVE ACTIONS ----------
        ...
        # Clean up other pending archives (but not the current one)
        ...
        context.user_data.pop("pending_archives", None)
        # Remove the stored prompt message ID (we are about to edit this message)
        if context.user_data.get("archive_prompt_msg_id"):
            context.user_data.pop("archive_prompt_msg_id", None)
        # Show action buttons – EDIT the current message (do NOT delete it first)
        keyboard = [
            [
...
def main():
    ...
    print("✅ Bot started with full password support and fixed single-archive menu.")
    app.run_polling()
